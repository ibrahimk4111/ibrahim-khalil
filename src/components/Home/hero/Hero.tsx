...
import resume from "/IBRAHIM KHALIL Resume.pdf";
          ...
          <div className=" sm:col-span-9 col-span-12 flex justify-between items-center">
            <div className=" relative  md:w-3/4 p-3">
              ...
              <p className=" dark:text-slate-300 text-slate-500 text-sm my-3">
                With practicing experience in web development, I specialize in
                React.js, Express.js, Node.js, MongoDB, JavaScript, TypeScript,
              ...
              <div className=" flex gap-2">
                ...
                <NavLink to={paths.Resume} className=" bg-cyan-500 relative inline-flex group p-2 mt-5 rounded-md hover:ring-1 ring-offset-1 transition-all overflow-hidden dark:hover:drop-shadow-glow ">
                  <span className=" absolute top-0 left-0 w-0 group-hover:w-full h-full -z-1 transition-all duration-500 ease-in-out bg-cyan-400"></span>
                  <span className="flex items-center gap-2 z-10 text-white">
                    <BiCoffee size={20} />
                    <span>Hire me</span>
