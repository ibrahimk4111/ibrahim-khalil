...
const Blogs = () => {
  return (
    <div className=" snap-center md:ml-12 lg:pt-16 md:pt-28 pt-20 px-2 pb-2 bg-slate-200 dark:bg-gradient-to-l from-bgColorsInDark via-[#001f1b] to-bgColorsInDark ">
